package top.javarem.skillDemo.controller;
...
import top.javarem.skillDemo.tool.ToolsManager;
        ...
        try {
            ...
            String response = openAiChatClient.prompt()
                    ...
                    .advisors(spec -> spec
                            ...
                            .param(AdvisorContextConstants.USER_ID, UUID.randomUUID().toString())
                    )
                    .toolContext(Map.of(ChatMemory.CONVERSATION_ID, request.getSessionId(), AdvisorContextConstants.USER_ID, UUID.randomUUID().toString()))
                    .call()
                    .content();
