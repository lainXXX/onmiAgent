    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-zinc-500">Your personal AI Agent</p>
        </div>

        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
          <h2 className="text-lg font-semibold text-zinc-100 mb-4">登录账户</h2>
        ...
        <p className="text-sm text-zinc-500 text-center mt-4">
          还没有账户？<Link to="/register" className="text-blue-400 hover:text-blue-300 transition-colors">立即注册</Link>
        </p>
      </div>
    </div>
  );
